		...
		<table border="1">
			...
			<%
				for (Tarefa tarefa : listaTarefas) {
					...
					out.println("<td><a href=\"TarefaController?operacao=Remover&id=" + tarefa.getId() + "\"><img src=\"lixeira.png\" height=\"20px\"></a></td>");
					out.println("<td><a href=\"TarefaController?operacao=Buscar&id=" + tarefa.getId() + "\"><img src=\"editar.png\" height=\"20px\"></a></td>");
					out.println("</tr>");
				}
			%>
		</table>
